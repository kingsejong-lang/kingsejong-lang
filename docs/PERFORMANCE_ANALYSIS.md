...
주요 개선 기회는 **함수 호출 오버헤드 감소**에 있으며, Tail Call Optimization과 함수 인라이닝을 통해 큰 성능 향상을 기대할 수 있습니다.

다음 릴리스(v0.6.0)에서는 TCO 구현을 목표로, fibonacci 벤치마크에서 30-50% 성능 개선을 달성할 계획입니다.
