# KingSejong 언어 기능 명세서

> KingSejong Programming Language Feature Specification
> 파일 확장자: `.ksj`

**버전**: v0.5.0 (Phase 8 완료)
**최종 수정**: 2025-11-21
**저장소**: https://github.com/0xmhha/kingsejonglang
**상태 기호**: ✅ 구현 완료 | 🚧 구현 중 | 📝 계획됨
...
**우선순위**: CRITICAL
**상태**: ✅ 구현 완료
**설명**: 수학적 표기와 일치하는 직관적 범위 (RangeExpression AST 노드 구현)
...
### F-CORE-003: Async/Await 비동기 처리 ✅

**우선순위**: HIGH
**상태**: ✅ 구현 완료
**설명**: AsyncFunctionLiteral, AwaitExpression AST 노드로 구현된 비동기 처리
...
**우선순위**: CRITICAL
**상태**: ✅ 구현 완료
**설명**: 자연어 기반 타입 선언 (정수, 실수, 문자열, 참거짓, 없음)
...
**우선순위**: HIGH
**상태**: ✅ 구현 완료
**설명**: null/undefined/None 혼란 제거 (단일 `없음` 키워드)
...
**우선순위**: HIGH
**상태**: ✅ 구현 완료
**설명**: 자연어 수준의 반복 표현 (10번 반복, i가 1부터 10까지, 각각에 대해)
...
8. ✅ 배열/객체
9. ✅ Async/Await 비동기
10. ✅ 에러 처리 (Try/Catch/Finally)
11. ✅ 파일 I/O (stdlib/io.ksj)
12. ✅ 명확한 에러 메시지
13. ✅ 모듈 시스템
14. ✅ 클래스 및 상속
15. ✅ 패턴 매칭
16. ✅ Bytecode VM + JIT
17. ✅ 세대별 GC
18. ✅ LSP, 디버거, VS Code 확장
19. ✅ ksjpm 패키지 관리자
20. ✅ Linter & Formatter

### ✅ Phase 8: 코드 품질 및 문서화 (완료!)
21. ✅ Doxygen 설정
22. ✅ USER_GUIDE.md
23. ✅ regression_test.py
24. ✅ 1,503개 테스트 (100% 통과)

### 📝 Phase 9 이후: 계획 중
25. [ ] 긴 함수 리팩토링
26. [ ] Incremental GC
27. [ ] 메모리 풀링 전략
28. [ ] stdlib 완성 (http, db 추가 함수)
29. [ ] 온라인 플레이그라운드 (WebAssembly)

---

**현재 상태**: v0.5.0, Phase 8 완료
**저장소**: https://github.com/0xmhha/kingsejonglang
**다음 단계**: [IMPLEMENTATION.md](./IMPLEMENTATION.md)에서 Phase 9 계획 확인
